...
- Do not commit real X Monitor API URLs, path settings, API keys, cookies,
  account IDs, private handles, local paths, screenshots with private data, or
  AWS details.
- Keep private X Monitor API settings configurable and blank in committed
  examples.
